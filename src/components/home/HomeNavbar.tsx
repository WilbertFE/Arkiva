      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link href="/signin">
              <Button variant="ghost" className="text-slate-600 cursor-pointer hover:text-blue-600 hover:bg-blue-50">
                Sign in
              </Button>
            </Link>
            <Link href="/signup">
              <Button className="bg-blue-600 hover:bg-blue-700 cursor-pointer text-white shadow-md hover:shadow-lg transition-all border-none">
                Sign up
              </Button>
            </Link>
          </div>
